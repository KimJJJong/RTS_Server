...
class SC_Test : IPacket
{
	public int testInt;

	public ushort Protocol { get { return (ushort)PacketID.SC_Test; } }
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		success &= BitConverter.TryWriteBytes(s.Slice(count, s.Length - count), (ushort)PacketID.SC_Test);
		count += sizeof(ushort);
...
class SC_Req_UserInfo : IPacket
{
	public int uid;

	public ushort Protocol { get { return (ushort)PacketID.SC_Req_UserInfo; } }
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		success &= BitConverter.TryWriteBytes(s.Slice(count, s.Length - count), (ushort)PacketID.SC_Req_UserInfo);
		count += sizeof(ushort);

...
public static class UnitStatDatabase
{
    ...
    public static void Load()
    {
        ...
        // Tower
        _stats[("TWR-ATK-001", 1)] = new UnitStat { UnitID = "TWR-ATK-001", Level = 1, MaxHP = 130, Speed = 0, AttackPower = -1, AttackRange = -1, IsProjectile = false };
        _stats[("TWR-DEF-001", 1)] = new UnitStat { UnitID = "SP-PNT-002",  Level = 1, MaxHP = 169, Speed = 0, AttackPower = -1, AttackRange = -1, IsProjectile = false };

        //Projection
        _stats[("PRJ-TWR-ATK-001", 1)] = new UnitStat { UnitID = "PRJ-TWR-ATK-001", Level = 1, MaxHP = 750, Speed =   3f, AttackPower = 40, AttackRange = -1, IsProjectile = true };
        ...
        _stats[("PRJ-U-ENG-003", 1)] = new UnitStat {   UnitID = "PRJ-U-ENG-003",   Level = 1, MaxHP = 750, Speed =   6f, AttackPower = 45, AttackRange = -1 , IsProjectile = true };

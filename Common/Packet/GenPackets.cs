...
class S_Req_UserInfo : IPacket
{
	public int uid;

	public ushort Protocol { get { return (ushort)PacketID.S_Req_UserInfo; } }
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		success &= BitConverter.TryWriteBytes(s.Slice(count, s.Length - count), (ushort)PacketID.S_Req_UserInfo);
		count += sizeof(ushort);
